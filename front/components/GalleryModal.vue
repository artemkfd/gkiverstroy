      ...
      <div class=" p-6 w-[80%]  lg:w-[65%] xl:w-[65%] text-center ">
        ...
        <div class="">
            <div class="flex relative gap-2 justify-center items-center  ">
                ...
                <img v-if="photoUndo" @click="emit('openNextPhoto', photoUndo)" :src="`/img/portfolio/${photoUndo}.webp`" alt="" class="z-20 hidden lg:block  rounded-xl relative translate-x-[50%] duration-300 filter grayscale hover:translate-x-[0] hover:cursor-pointer hover:-rotate-2 hover:grayscale-0 w-[50%] h-[80vh]">
              
                    <img v-if="photoItem" @click="emit('close')" :src="`/img/portfolio/${photoItem}.webp`" alt="" class="z-40 relative shadow-xl rounded-xl bg-gray-200/80 p-1 h-[80vh]">
              
                <img v-if="photoNext" @click="emit('openNextPhoto', photoNext)" :src="`/img/portfolio/${photoNext}.webp`" alt="" class="z-20 hidden lg:block rounded-xl relative translate-x-[-50%] duration-300 filter grayscale hover:translate-x-[0] hover:cursor-pointer hover:rotate-2  hover:grayscale-0 w-[50%] h-[80vh]">
