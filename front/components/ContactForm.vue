<template>
    <div class="flex justify-center items-center min-h-screen bg-gray-100">
        <div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            <h2 data-aos="fade-up" data-aos-once="true" data-aos-delay="300" class="text-2xl font-bold mb-4">Связаться с нами легко!</h2>
            ...
            <form data-aos="fade-right" data-aos-once="true"  data-aos-delay="350" @submit.prevent="handleSubmit">
                <div class="mb-4">
                ...
                <button type="submit" @click="handleSubmit" class="w-full bg-sky-500 text-white font-bold py-2 rounded-xl hover:bg-sky-600 focus:outline-none focus:ring-2 focus:ring-sky-300">Отправить</button>
            </form>
        </div>
    </div>
</template>
